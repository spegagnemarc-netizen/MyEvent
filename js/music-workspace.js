...
(function(){
  ...
  function renderHome(){
    ...
    extra.innerHTML='<div class="musicCards musicHeroCards"><button data-go="playlists" class="musicIllustrated musicHeroPlaylists"><span class="musicHeroIcon">♫</span><b>Mes playlists</b><small>Vos playlists personnelles</small><i>›</i></button><button data-go="discover" class="musicIllustrated musicHeroDiscover"><span class="musicHeroIcon">▶</span><b>Découvrir</b><small>Explorer YouTube</small><i>›</i></button><button data-go="ai" class="musicIllustrated musicHeroAI"><span class="musicHeroIcon">✦</span><b>Music IA</b><small>Composer une proposition</small><i>›</i></button><button data-go="library" class="musicIllustrated musicHeroLibrary"><span class="musicHeroIcon">♥</span><b>Bibliothèque</b><small>Favoris et historique</small><i>›</i></button></div><div class="musicForYouHead"><h3>Pour vous</h3><button type="button" data-go="discover">Voir tout ›</button></div><p>Retrouvez vos écoutes et explorez vos ambiances favorites.</p><section class="musicShelf"><div class="musicShelfHead"><h3>◷ Écoutés récemment</h3><button type="button" data-go="library">Voir tout ›</button></div><div id="musicRecent"></div></section><section class="musicShelf musicGenreShelf"><div class="musicShelfHead"><h3>♫ Genres</h3><button type="button" data-music-filter="genres">Voir tout ›</button></div><div id="musicGenres"></div></section>';
