...
(function(){
  ...
  function renderHome(){
    ...
    for(const genre of ['Pop','Jazz','Rock','Électro','Classique'])button(genre,()=>{go('discover');search(genre);},$('musicGenres'));
  }
